...
const propTypes = {
  ...
  /**
   * the string name to be used as user location marker
   * this image will be rotated based on the heading value passed from `updateUserHeading` method.
   * 
   * Make sure to disable map rotated when use this feature, otherwise the user heading may not be correct when map rotated.
   */
  userLocationHeadingImageName: PropTypes.string,
...
class MapView extends React.Component {
  ...
  updateUserHeading(heading) {
    this._runCommand('updateUserHeading', [heading]);
  }
